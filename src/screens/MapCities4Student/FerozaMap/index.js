...
const FerozaMap = ({ route }) => {
    ...
    useEffect(() => {
        ...
        const ref = database().ref(`busLocations/Feroza/${busNumber}`);
        ref.once('value')
            .then(snapshot => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <TouchableOpacity onPress={()=>navigation.navigate('FerozaTracking')}>
