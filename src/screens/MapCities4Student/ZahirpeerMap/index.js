...
const ZahirpeerMap = ({ route }) => {
    ...
    useEffect(() => {
        ...
        const ref = database().ref(`busLocations/Zahirpeer/${busNumber}`);
        ref.once('value')
            .then(snapshot => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <TouchableOpacity onPress={()=>navigation.navigate('ZahirpeerTracking')}>
