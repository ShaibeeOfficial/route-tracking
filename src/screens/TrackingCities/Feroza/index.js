...
const FerozaTracking = ({ navigation }) => {
  const data = [
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity
      ...
      onPress={() => {
        ...
        navigation.navigate('FerozaMap', { busNumber: item.busNumber });
      }}
    >
  ...
  return (
    <View style={Style.container}>
      ...
      <View style={Style.header}>
        ...
        <View style={{ width: '25%' }} />
        <Text style={Style.headerText}>FerozaTracking</Text>
      </View>
