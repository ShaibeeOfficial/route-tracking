...
const SardargarhTracking = ({ navigation }) => {
  const data = [
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity
      ...
      onPress={() => {
        ...
        navigation.navigate('SardargarhMap', { busNumber: item.busNumber });
  ...
  return (
    <View style={Style.container}>
      ...
      <View style={Style.header}>
        ...
        <View style={{ width: '22%' }} />
        <Text style={Style.headerText}>SardargarhTracking</Text>
      </View>
...
export default SardargarhTracking;