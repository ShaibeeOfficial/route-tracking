...
const FerozaMapDriver = ({ route }) => {
  ...
  const saveLocation = () => {
    database()
      .ref(`busLocations/Feroza/${item.busNumber}`)
      .set({
        latitude: lat,
        longitude: long,
      })
      .then(() => {
        ...
        showLocalNotification('Route Tracking', 'Your Feroza Bus is Leaving in 15 minutes!! Hurry up');
      })
      .catch(error => {
...
export default FerozaMapDriver;
